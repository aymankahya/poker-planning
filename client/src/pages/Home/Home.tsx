  ...
  return (
    <>
      <div className="z-20 flex flex-col items-center gap-2 scroll-smooth mt-20 md:mt-40">
        <div
          tabIndex={0}
          className="group flex gap-2 items-center text-zinc-300 text-sm w-fit px-5 py-1.5 rounded-full bg-black cursor-pointer hover:text-white focus:text-white transition-all ease-in-out duration-300"
        >
        ...
        <div className="flex gap-5 mt-5 ">
          <Button className="bg-black hover:bg-black/90 transition-all ease-in-out duration-300">
            Create a session
          </Button>
